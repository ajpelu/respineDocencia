...
body <- dashboardBody(
  fluidRow(
    column(
      ...
      fluidRow(
        box(
          h4(div(strong("Paisaje"), style = "color:green")),
          sliderInput(
            inputId = "size_pp", label = "Tamaño de la repoblación de pinar",
            min = 200, max = 1500, value = 750
          ),
          selectInput(
            inputId = "density_pp", label = "Densidad de la plantación",
            choices = c("baja", "media", "alta"), selected = "media"
          ),
          selectInput(
            inputId = "pp_pastUse", label = "Uso del pasado",
        ...
        box(
          h4(div(strong("Dispersantes"), style = "color:green")),
          sliderInput(
            inputId = "sb", label = "Aves pequeño tamaño",
        ...
        box(
          h4(div(strong("Simulación"), style = "color:green")),
